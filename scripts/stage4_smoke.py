"""Run one deterministic question through AST validation and read-only execution."""
...
from backend.runtime.stage4 import create_stage4_runtime
...
def main() -> int:
    ...
    runtime = create_stage4_runtime(ROOT, get_settings())
    try:
