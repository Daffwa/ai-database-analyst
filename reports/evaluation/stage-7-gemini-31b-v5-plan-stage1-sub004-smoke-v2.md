...
| Metric | Result |
|---|---:|
| Passed cases | 1/1 (100.00%) |
| Structured-output validity | 1/1 (100.00%) |
| Valid SQL | 1/1 (100.00%) |
| Execution success | 1/1 (100.00%) |
...
| Latency P50/P95 | 18739.79 / 18739.79 ms |
| Input/output tokens | 2205 / 616 |
