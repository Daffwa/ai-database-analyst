...
| Metric | Result |
|---|---:|
| Passed cases | 0/2 (0.00%) |
| Structured-output validity | 2/2 (100.00%) |
| Valid SQL | 2/2 (100.00%) |
| Execution success | 2/2 (100.00%) |
| Execution accuracy | 0/2 (0.00%) |
| Schema hallucination | 0/2 (0.00%) |
| Unsafe protection | 0/0 (100.00%) |
| False blocking | 0/2 (0.00%) |
| Clarification accuracy | 0/0 (100.00%) |
| Latency P50/P95 | 11632.58 / 17249.71 ms |
| Input/output tokens | 3549 / 801 |
| Presentation-equivalent passes | 0 |
| Substantive result mismatches | 2 |

## Failure Categories

- `multi_table_join`: JON-003
- `subquery`: SUB-001
